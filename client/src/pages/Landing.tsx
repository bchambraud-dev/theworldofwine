        ...
        <div className="lp-section">
          <div className="lp-sommy-layout">
            <div>
              ...
              <button className="lp-cta" onClick={() => { track("cta_ask_sommy"); window.dispatchEvent(new CustomEvent("open-sommy")); }}>
                Ask Sommy
        ...
        <div className="lp-section">
          <div className="lp-map-layout">
            ...
            <div>
              ...
              <button className="lp-cta" onClick={() => { track("cta_explore_map"); setLocation("/explore?reset=1"); }}>
                Explore the Map
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M5 12h14"/><path d="M12 5l7 7-7 7"/></svg>
              </button>
            </div>
