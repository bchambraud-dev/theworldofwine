  ...
  return (
    <div style={s.page}>
      <div style={s.inner}>
        ...
        <p style={s.p}>
          The World of Wine is an interactive wine education and exploration platform. It includes an AI wine companion (Sommy), an interactive wine region map, curated guides, producer listings, wine journaling tools, and personalised learning features.
        </p>
        <p style={s.p}>
        ...
        <p style={s.p}>
          Sommy is an AI-powered wine companion designed to provide educational information and general wine recommendations. Sommy's responses are generated by artificial intelligence and should be treated as guidance rather than professional advice.
        </p>
        <p style={s.p}>
