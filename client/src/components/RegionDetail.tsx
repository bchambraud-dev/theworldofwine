    ...
    <div style={{ margin: "10px 0 6px" }}>
      <button
        ...
        style={{
          ...
          padding: "6px 14px", border: "1.5px solid #EDEAE3", borderRadius: 8,
          background: open ? "#F7F4EF" : "transparent", cursor: "pointer",
          fontFamily: "'Geist Mono', monospace", fontSize: "0.56rem", fontWeight: 500,
          letterSpacing: "0.06em", color: "#8C1C2E", textTransform: "uppercase",
      ...
      {open && facts && facts.length > 0 && (
        <div style={{
          marginTop: 10, padding: "12px 14px", background: "rgba(140,28,46,0.03)",
          borderRadius: 10, borderLeft: "3px solid rgba(140,28,46,0.15)",
        }}>
    ...
    <>
      <button
        ...
        style={{
          ...
          color: "#8C1C2E", marginTop: 4, display: "inline-flex", alignItems: "center", gap: 4,
        }}
      >
        {loading ? "Expanding..." : open ? "Show less" : "Read more"}
        {!loading && (
          <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ transform: open ? "rotate(180deg)" : "rotate(0)", transition: "transform 0.2s" }}>
      ...
      {open && expanded && (
        <div style={{
          marginTop: 10, fontFamily: "'Jost', sans-serif", fontSize: "0.88rem",
          fontWeight: 300, color: "#1A1410", lineHeight: 1.7,
          whiteSpace: "pre-wrap",
        }}>
          {expanded}
        </div>
