...
export const guides: Guide[] = [
  // ── GUIDE 1 ───────────────────────────────────────────────────────────────────
  {
    ...
    sections: [
      { heading: "The Grape Itself: Skin, Pulp, and Seeds", content: `Before we talk about the land, it helps to understand what we're actually working with. A wine grape isn't like a table grape — it's smaller, more concentrated, and far sweeter. Inside that tiny berry is a whole world of possibility, and different parts of it contribute very different things to your glass.

The <strong>skin</strong> is where colour and tannin live. Red grapes have pigments in their skins called anthocyanins — that's what gives red wine its colour. Leave the juice in contact with the skins, and colour and tannin transfer across. Remove the juice early, and you barely pick up any colour at all. The <strong>pulp</strong> is where the juice is — mostly water, sugar, and acid. That's the raw material of every wine, regardless of colour. The <strong>seeds</strong> contain bitter, harsh tannins that winemakers generally try to avoid extracting, which is why you'll rarely see wines pressed aggressively enough to crack them.

This distinction is the foundation of the whole red-versus-white divide. White wine is almost always pressed off the skins immediately — you barely let them touch. Red wine goes through <strong>maceration</strong>, where the juice sits with the skins for days or weeks, pulling out all that colour, tannin, and texture. Rosé sits somewhere in between — more on that later. Understanding this single anatomical fact explains more about winemaking than almost anything else.` },
      { heading: "The Vine's Year: From Bud Break to Harvest", content: `The wine in your glass is the product of a single year's work — or rather, a single year in a continuous cycle that the vine goes through every twelve months without fail. Understanding that cycle makes terroir make sense, because terroir is largely about how climate shapes that cycle.

In winter, the vine is dormant — bare, seemingly lifeless. Then comes <strong>bud break</strong> in spring, when the first green shoots push through. This is a vulnerable moment: a late frost at bud break can wipe out an entire vintage. Flowering follows in late spring, and this is where quantity is determined — poor weather during flowering means fewer berries. By midsummer comes <strong>veraison</strong>, the moment when the grapes change colour (red varieties turn from green to purple, white varieties from green to gold) and begin to accumulate sugar. Then the long, slow ripening stretch toward <strong>harvest</strong> in autumn.

Here's where climate comes in. In a <strong>cool climate</strong> — northern France, Germany, parts of New Zealand — the growing season is long and slow. Grapes ripen gradually, holding onto high acidity and developing delicate, nuanced flavours. In a <strong>warm climate</strong> — California, southern Spain, much of Australia — ripening is faster and more emphatic. Sugars build quickly, producing more alcohol, riper fruit, and lower acidity. Neither is inherently better; they produce wines of fundamentally different character. And the land — its latitude, altitude, aspect, proximity to water — is what determines which type of season a vine experiences. That's exactly what terroir is about.` },
      {
  ...
  // ── GUIDE 5 ───────────────────────────────────────────────────────────────────
  {
    ...
    sections: [
      ...
      { heading: "The Sparkling Showdown: Champagne vs Prosecco vs Cava", content: `These three names come up constantly, and they're often used interchangeably in ways that would horrify the people who make them. Let me give you the honest, useful version of how they differ — because the differences are real and they affect both what you're tasting and what you're paying for.

<strong>Champagne</strong> comes only from the Champagne region of northern France, made primarily from Chardonnay, Pinot Noir, and Pinot Meunier. What makes it distinctive is the <strong>traditional method</strong>: the wine undergoes a second fermentation inside the individual bottle, which produces the bubbles and, over time, those characteristic toasty, bready, brioche-like flavours from contact with the spent yeast. It's labour-intensive, time-consuming, and reflects it in the price — expect to pay £30 to £200 or more. <strong>Prosecco</strong>, from northeastern Italy's Veneto and Friuli regions, is made using the <strong>tank method</strong> (also called Charmat): the second fermentation happens in a large pressurised tank rather than in each bottle, which preserves fresh, fruity, floral aromas — think green apple, peach, and cream. It's lighter, simpler, and genuinely lovely for what it is. <strong>Cava</strong>, from Spain (primarily Catalonia), uses the same traditional bottle-fermentation method as Champagne but with indigenous Spanish grape varieties — Macabeo, Parellada, and Xarel·lo. The result is a more earthy, almond-inflected style at a price point that makes it one of wine's great values.

The key takeaway is this: the method of production — bottle fermentation versus tank fermentation — is the single biggest quality differentiator in sparkling wine. Bottle fermentation creates texture, complexity, and that nutty, yeasty depth. Tank fermentation produces a fresher, fruitier, simpler style. Neither is wrong, but they're not the same thing — and understanding that makes the price difference make sense.` },
      { heading: "Port & Sherry: Fortified Wines Demystified", content: `Fortified wines are two of the most misunderstood and underappreciated categories in the wine world. Most people associate them with dusty bottles at their grandparents' house, or with sticky sweetness, or both. The reality is far more interesting — and the range of styles is extraordinary.

<strong>Port</strong> comes from Portugal's Douro Valley, one of the most dramatically beautiful wine regions on earth. It's made by adding grape spirit (neutral brandy) to a fermenting red wine, which kills the yeast mid-fermentation — leaving residual sugar in the wine and raising the alcohol to around 20%. The result is sweet, rich, and warming. <strong>Ruby Port</strong> is the young, fruit-forward style, full of dark cherry and blackberry. <strong>Tawny Port</strong> is aged in small barrels, slowly oxidising into something nutty, dried-fruit, caramel-laced, and magnificent with a piece of good cheese. <strong>Vintage Port</strong> is the serious stuff — wine from a single exceptional year, aged in bottle for decades, and among the most age-worthy wines on the planet.

<strong>Sherry</strong> is Port's Spanish counterpart, from the hot, chalky Jerez region of Andalusia — and it's where the real surprise is. Because unlike Port, Sherry is fortified <strong>after</strong> fermentation, meaning it starts completely dry. <strong>Fino</strong> is pale, razor-sharp, intensely dry, and faintly yeasty from the flor (a film of yeast that protects it during ageing) — serve it cold, like a white wine, with olives and salted almonds. <strong>Amontillado</strong> is a Fino that lost its flor and continued to age, picking up nutty, amber complexity. <strong>Oloroso</strong> is dark, rich, and walnut-dry. Then there's <strong>Pedro Ximénez</strong> — PX — which is made from sun-dried grapes, intensely sweet, like liquid dark raisins poured over vanilla ice cream. If you've only ever had sticky sweet Sherry from a low-quality bottle, the good stuff is a revelation.` },
      { heading: "Sauternes & Botrytis: The Noble Rot", content: `There's a fungus that, under the right conditions, produces some of the most extraordinary wine in the world. Its name is <strong>Botrytis cinerea</strong>, and in most contexts it's a viticultural nightmare — grey rot, destroying fruit, ruining harvests. But in very specific conditions of morning mist followed by warm, sunny afternoons, it transforms into something winemakers call <strong>noble rot</strong>. Rather than destroying the grape, it dehydrates it, shrivelling the berry and concentrating the sugars, acids, and flavours inside. The resulting juice is thick, golden, and almost absurdly concentrated, with aromas of honey, apricot, orange peel, and saffron.

<strong>Sauternes</strong>, from Bordeaux's southern bank, is the most famous expression of this style — a blend of Sémillon and Sauvignon Blanc affected by botrytis, producing wines of astonishing richness and extraordinary longevity. A good Sauternes at twenty years old is one of wine's peak experiences: layers of dried apricot, marmalade, ginger, and lanolin, all held together by a spine of acidity that keeps it from ever feeling heavy. But Sauternes isn't alone. <strong>Tokaji Aszú</strong> from Hungary does the same thing with Furmint; <strong>Trockenbeerenauslese</strong> from Germany and Austria represents the pinnacle of that country's sweetness spectrum; and great Chenin Blanc from the Loire Valley — Vouvray and Quarts de Chaume — can achieve similar magic.

These wines are expensive, and the reason is simple: <strong>yields are tiny</strong>. A vine that might normally produce a full bottle of wine might produce just a glass of Sauternes in a botrytis vintage. Harvesters pass through the vineyard multiple times, picking individual berries by hand when they reach the right level of infection. It's painstaking, unpredictable work, entirely at the mercy of the autumn weather. When it works, though, the result is something that can outlive the person who made it.` },
    ],
      ...
      },
      {
        ...
        content:
          "Here's a counterintuitive one: off-dry and sweet wines often pair better with spicy food than dry wines do. Why? Alcohol amplifies the perception of heat — so a high-alcohol dry red with a spicy Thai curry can feel like you're eating fire. A slightly sweet, lower-alcohol Riesling or Gewürztraminer provides sweetness that tames the spice and alcohol that doesn't amplify it. It's one of wine's most useful and underused principles.\n\nGewürztraminer is basically custom-made for this role: its naturally sweet, aromatic, spiced character echoes and harmonizes with the complex spice of Thai, Chinese, and Alsatian cuisine (hence the choucroute pairing). German Riesling Spätlese with Vietnamese pho or Japanese ramen is a revelation once you've tried it. Don't be scared of sweet wines as food pairings — they're often the most elegant solution.\n\nConversely, wine and very sweet desserts can be tricky: the wine needs to be as sweet or sweeter than the dessert, or the wine tastes thin and acidic by comparison. That's why the classic pairing is Sauternes with Roquefort (the sweetness balances the salt and tang of the cheese) rather than Sauternes with crème brûlée (two sweet things fighting for attention).",
            ...
            { heading: "The Umami Effect (and Why Chilli Changes Everything)", content: `There are two interactions that trip people up more than any other when pairing wine with food, and they're both about flavour compounds that amplify the wine's less desirable qualities. Understanding them doesn't just help you make better choices — it explains why certain pairings that seem logical on paper feel completely wrong in practice.

<strong>Umami</strong> — the savoury, meaty, deeply satisfying fifth taste — is found in soy sauce, aged Parmesan, dried mushrooms, cured meats, anchovies, and tomato paste. It's one of the reasons these ingredients make food taste so good. But umami has a specific and unwelcome effect on wine: it amplifies bitterness and tannin. A Cabernet Sauvignon that tastes perfectly structured on its own can suddenly feel harsh, drying, and almost metallic when paired with a dish high in umami. The wine hasn't changed; the food is exaggerating its tannins. The solution is to reach for wines that are <strong>fruity, lower in tannin, and moderate in alcohol</strong>. Pinot Noir is the classic answer to mushroom risotto — just enough structure, lots of red fruit, and no aggressive tannin to clash. An off-dry Riesling alongside soy-glazed salmon turns the umami intensity from a problem into a pleasure.

<strong>Chilli heat</strong> does something different but equally disruptive: it amplifies the perception of alcohol. A bold 14.5% Shiraz that feels balanced on its own will feel like it's burning your mouth with a spicy Thai curry — the heat from the food and the heat from the alcohol compound each other. The fix is the same principle: go lower in alcohol, and consider a touch of sweetness to cool the heat. A <strong>Riesling Kabinett</strong> — low alcohol, slightly off-dry — is a revelation with pad Thai. Vinho Verde's gentle spritz and lightness works beautifully with Mexican food. <strong>Gewürztraminer</strong>, with its lychee-and-rose exuberance and naturally low acid, is one of the few wines that can hold its own against the numbing complexity of Sichuan cuisine. These aren't obscure choices — they're simply wines built for the job.` },
      {
      ...
      },
      {
        ...
        content:
          "For red wine, fermentation and maceration happen simultaneously: the juice (must) macerates on the grape skins, extracting color pigments (anthocyanins), tannins, and flavor compounds that are only present in the skins, not the juice itself. <strong>This skin contact is what makes red wine red</strong> — white grapes, even those with pink or red skins, can make white wine if you remove the skins immediately after crushing.\n\nHow long and how aggressively you macerate determines the style of the wine. Gentle extraction over a moderate time produces wines that are more elegant, with softer tannins and brighter fruit. Aggressive extraction — longer maceration, intensive pump-overs (pumping juice from the bottom of the tank over the 'cap' of skins that floats on top) or punch-downs — produces more deeply colored, more tannic, more structured wines. The right approach depends entirely on the grape variety, the vintage, and the style you're aiming for.\n\nPigéage (punch-down) is the traditional method for moving the cap: workers literally push the floating mass of skins down into the liquid with poles or paddles. It's gentle and effective. Délestage (rack and return) is more dramatic — draining all the liquid off the skins and then pouring it back over — and produces wines with more structural tannin. The options are many, the philosophy is what differentiates producers.",
            ...
            { heading: "Rosé: Three Ways to Make It", content: `Rosé is one of the most misunderstood categories in wine. People assume it's just a mixture of red and white, or that it's not a serious style. Neither is true. In fact, the way rosé is made is a direct expression of everything we've just talked about with maceration — it's essentially a decision about how much skin contact to allow before pulling the plug.

The most common method is <strong>short maceration</strong>: red grapes are crushed and left in contact with their skins for anywhere from two to twenty-four hours. The winemaker watches the colour develop and presses when it reaches the right shade. This is how the famous pale, delicate rosés of Provence are made — a very brief conversation with the skins, then straight to pressing. A second approach is <strong>direct press</strong>, where the red grapes are pressed immediately with virtually no maceration at all, resulting in the palest, most gossamer rosés you'll find. Then there's <strong>saignée</strong> — which is French for 'bleeding.' Early in a red wine fermentation, a portion of juice is bled off from the tank. The red wine that remains becomes more concentrated (because there's less juice relative to the skins); the juice that's been bled off becomes rosé as a happy byproduct.

The one thing that's generally not done — except in Champagne, where it's a long-established tradition — is blending finished red and white wine together to make rosé. Most winemaking regions actually prohibit it. So the next time someone tells you rosé is just white wine with a splash of red in it, you can gently set them straight.` },
      {
  ...
  // ── GUIDE 12 (INTERMEDIATE) ───────────────────────────────────────────────────
  {
    ...
    sections: [
      ...
      { heading: "Preserving Opened Wine", content: `The moment you pull a cork, the clock starts. Oxygen is wine's best friend during the slow, controlled process of ageing — and its worst enemy once the bottle is open. But there's quite a lot you can do to slow that process down, and knowing your options makes a real practical difference.

The simplest and most underused trick is <strong>the fridge</strong>. Re-cork the bottle and put it in the refrigerator, even if it's a red. Cold temperatures dramatically slow oxidation — a red wine that might be flat and dull the next evening at room temperature can be perfectly enjoyable when chilled and then allowed to warm in the glass. Most wines will hold for two to three days this way. For a step up from that, a <strong>vacuum pump</strong> — the most common being the VacuVin — removes air from the bottle before you re-seal it. It's cheap, it works reasonably well, and it'll buy you an extra day or two. If you're serious about preservation, <strong>inert gas sprays</strong> like Private Preserve use a blend of argon, carbon dioxide, and nitrogen to blanket the wine's surface, preventing oxygen contact without removing it. And then there's <strong>Coravin</strong>, which inserts a thin needle through the cork to extract wine while replacing it with argon — meaning the cork reseals and the bottle can, in theory, last months.

Two special cases worth knowing: <strong>sparkling wine</strong> needs a proper sparkling wine stopper — a hinged metal clamp that grips the bottle neck and forms a seal. These keep bubbles alive for a day or two. The old trick of hanging a spoon in the neck of the bottle does nothing; it's a myth. And <strong>fortified wines</strong> — Port, Sherry — are much more resilient than still wines, because the added spirit protects them. A good Fino Sherry will still be drinking well a week after opening (keep it in the fridge). A Tawny Port, weeks. Don't leave them open indefinitely, but don't panic either.` },
      { heading: "Opening Sparkling Wine Safely", content: `A Champagne cork exits the bottle at roughly the same speed as a tennis ball served by a professional player. That's not a figure of speech — it's physics. A bottle of sparkling wine contains enough pressure to make the cork genuinely dangerous if you handle it carelessly, and every year people injure themselves or others by treating the pop as a moment of drama rather than something to be managed. Let me walk you through doing it properly.

First: <strong>chill the bottle</strong>. A warm bottle of sparkling wine has more pressure than a cold one, and warm gas expands faster when released. An insufficiently chilled bottle is an unpredictable bottle. Once you're ready to open it, remove the foil and then the wire cage — but keep your thumb firmly on top of the cork while you do this. The cage is the only thing between you and a premature launch. Hold the bottle at a <strong>45-degree angle</strong> (this maximises the surface area inside the neck, slowing the release of pressure), grip the cork firmly, and twist the <strong>base of the bottle</strong> rather than the cork itself. The bottle should turn while the cork stays still in your hand.

What you're aiming for is a <strong>gentle sigh</strong> — a quiet exhale of pressure, not a dramatic pop. That pop is theatre, not quality. Every decibel of that bang is CO2 leaving the bottle and taking your bubbles with it. The quieter the opening, the more of the wine's effervescence you've preserved. Point the bottle away from faces, lights, and anything fragile. Take your time. Done properly, opening a bottle of Champagne feels effortless and elegant — and the wine in the glass will show for it.` },
    ],
    relatedJourneyIds: [],
